				...
				<div class="hor-menu ">
					<ul class="nav navbar-nav">
						...
						<li class="menu-dropdown mega-menu-dropdown "><a
							...
							class="dropdown-toggle"> Features <i class="fa fa-angle-down"></i>
						</a>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<ul class="mega-menu-submenu">
													...
													<li><a href="layout_top_bar_fixed.html"
														class="iconify"> <i class="icon-bar-chart"></i> Fixed
															Top Bar
													</a></li>
											...
											<div class="col-md-4">
												<ul class="mega-menu-submenu">
													...
													<li><a href="layout_disabled_menu.html"
														class="iconify"> <i class=" icon-lock"></i> Disabled
															Menu Links
													</a></li>
												</ul>
											</div>
						...
						<li class="menu-dropdown mega-menu-dropdown mega-menu-full ">
							...
							data-toggle="dropdown" href="javascript:;"
							class="dropdown-toggle"> UI Components <i
						...
						<li class="menu-dropdown mega-menu-dropdown mega-menu-full ">
							<a data-hover="megamenu-dropdown" data-close-others="true"
							data-toggle="dropdown" href="javascript:;"
							class="dropdown-toggle"> Pages <i class="fa fa-angle-down"></i>
						</a>
							<ul class="dropdown-menu">
								<li>
									<div class="mega-menu-content">
